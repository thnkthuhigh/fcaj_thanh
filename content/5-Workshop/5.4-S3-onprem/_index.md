...
<img src="/fcaj_thanh/images/5-Workshop/AWS-Console/admin-approve-dashboard.png" alt="Admin dashboard with pending document" style="max-width: 90%; height: auto;">

**Step 2:** Approve the document from the administrator view and check the success response (toast notification).

<img src="/fcaj_thanh/images/5-Workshop/AWS-Console/admin-approve-toast.png" alt="Approval success notification" style="max-width: 90%; height: auto;">
...
<img src="/fcaj_thanh/images/5-Workshop/AWS-Console/search-result.png" alt="Approved document in search results" style="max-width: 90%; height: auto;">
