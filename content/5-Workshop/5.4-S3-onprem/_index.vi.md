...
<img src="/fcaj_thanh/images/5-Workshop/AWS-Console/admin-approve-dashboard.png" alt="Dashboard admin hiển thị tài liệu đang chờ duyệt" style="max-width: 90%; height: auto;">
...
<img src="/fcaj_thanh/images/5-Workshop/AWS-Console/admin-approve-toast.png" alt="Thông báo xác nhận sau khi admin duyệt và xuất bản tài liệu" style="max-width: 90%; height: auto;">
...
<img src="/fcaj_thanh/images/5-Workshop/AWS-Console/search-result.png" alt="Trang kết quả tìm kiếm hiển thị tài liệu đã được duyệt" style="max-width: 90%; height: auto;">
